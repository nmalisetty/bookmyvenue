...
export default () => {
    ...
    async function getBookmark(venueId) {
        let response = await fetch('http://localhost:6969/venues/bookmarks/' + sessionStorage.getItem('user_name') + '/' + venueId, {
            method: 'GET'
        });
    ...
    async function createBookmark(userId, venueId) {
        let response = await fetch('http://localhost:6969/venues/bookmarks', {
            method: 'POST',
            body: JSON.stringify({
                user_id: userId,
                venue_id: venueId
    ...
    async function deleteBookmark(userId, venueId) {
        let response = await fetch('http://localhost:6969/venues/bookmarks/' + userId + '/' + venueId, {
            method: 'DELETE'
        });
        let jsonResponse = await response.json();
    ...
    async function getReservationDetails() {
        let response = await fetch('http://localhost:6969/reservations/'.concat(sessionStorage.getItem('editReservationId')), {
            method: 'GET'
        });
        let jsonResponse = await response.json();
        if (jsonResponse.status) {
    ...
    useEffect(() => {
        async function getVenueDetails() {
            let response = await fetch('http://localhost:6969/venues/'.concat(sessionStorage.getItem('venueId')), {
                method: 'GET'
            });
            let jsonResponse = await response.json();
            if (jsonResponse.status) {
